...
import 'package:emprendimientos/models/tabIcon_data.dart';


class BottomBarView extends StatefulWidget {
  const BottomBarView({Key? key, this.tabIconsList, this.changeIndex, this.addClick}) :
        super(key: key);
        ...
        AnimatedBuilder(
          ...
          builder: (BuildContext context, Widget? child) {
            return Transform(
              ...
              child: PhysicalShape(
                color: EmprendimientosAppTheme.white,
                elevation: 16.0,
                clipper: TabClipper(
                  ...
                  child: ScaleTransition(
                    ...
                    /* child: Container(
                      ...
                      decoration: BoxDecoration(
                        color: EmprendimientosAppTheme.nearlyDarkBlue,
                        gradient: LinearGradient(
                            colors: [
                              EmprendimientosAppTheme.nearlyDarkBlue,
                              HexColor('#6A88E5'),
                            ],
